...
def model_process(X_train, y_train, X_test):
    ...
    # Lightgbm训练过程
    # model_soccer = lgb.LGBMRegressor(boosting_type='gbdt', learning_rate=0.05, n_estimators=1000, num_leaves=160,
    #                                  max_depth=-1,
    #                                  min_data_in_leaf=5, subsample=0.85, colsample_bytree=0.9,
...
def lgb_cv(X_train, Y_train):
    ...
    # model = lgb.LGBMRegressor(boosting_type='gbdt', learning_rate=0.1, n_estimators=70, num_leaves=85, max_depth=-1,
    #                           min_data_in_leaf=3, subsample=0.85, colsample_bytree=0.9,
    #                           min_split_gain=0.3, reg_alpha=5, reg_lambda=3, metric='mae')
    model = lgb.LGBMRegressor(boosting_type='gbdt', learning_rate=0.05, n_estimators=1000, num_leaves=160, max_depth=-1,
                              min_data_in_leaf=5, subsample=0.85, colsample_bytree=0.9,
                              min_split_gain=0.3, reg_alpha=5, reg_lambda=3, metric='mae')
